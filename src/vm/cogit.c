/* Automatically generated by
	CCodeGenerator VMMaker-oscog-HolgerHansPeterFreyther.309 uuid: d6bc40bb-b96a-497b-8c00-564713877f19
   from
...
static void copyInstructionsFromupTo(sqInt start, sqInt end);
...
static sqInt genPrimitiveNBNativeCall(void);
...
{
	// Cogit>>#checkIfValidObjectRefAndTarget:pc:cogMethod:
    sqInt cacheTag;
    sqInt entryPoint;
    sqInt literal;
    sqInt off;
...
{
	// Cogit>>#checkIfValidObjectRef:pc:cogMethod:
    sqInt cacheTag;
    sqInt literal;
...
{
	// CogObjectRepresentationForSqueakV3>>#checkValidObjectReference:
	return ((anOop & 1))
...
/*	since there's only Fill32:
	we must align copied machine code size to 4-bytes filling the extra tail
	with NOP instructions
 */

static void
copyInstructionsFromupTo(sqInt start, sqInt end)
{
	// NBCogit>>#copyInstructionsFrom:upTo:
    sqInt b1;
    sqInt b2;
    sqInt b3;
    sqInt b4;
...
{
	// Cogit>>#findEnclosingMethodFor:inHomeMethod:
...
{
	// Cogit>>#findMcpc:Bcpc:MatchingBcpc:
...
{
	// Cogit>>#findMcpc:Bcpc:MatchingMcpc:
...
{
	// Cogit>>#findMinAndMaxMethodsPC:around:
...
{
	// CogObjectRepresentationForSqueakV3>>#genConvertSmallIntegerToIntegerInScratchReg:
...
{
	// CogObjectRepresentationForSqueakV3>>#genGetClassObjectOf:into:scratchReg:
    AbstractInstruction *jumpCompact;
    AbstractInstruction *jumpGotClass;
...
{
	// CogObjectRepresentationForSqueakV3>>#genGetCompactClassIndexNonIntOf:into:
    sqInt quickConstant;
    sqInt quickConstant1;
...
{
	// CogObjectRepresentationForSqueakV3>>#genGetHashFieldNonIntOf:asSmallIntegerInto:
	/* begin MoveMw:r:R: */
genoperandoperandoperand(MoveMwrR, 0, instReg, destReg);
	/* begin LogicalShiftRightCq:R: */
...
static sqInt
genPrimitiveNBNativeCall(void)
{
	// NBCogit>>#genPrimitiveNBNativeCall
    sqInt instr;
    sqInt len;
    sqInt pos;
    sqInt trailer;
	...
	len = lengthOf(methodObj);
	trailer = byteAt(((methodObj + BaseHeaderSize) + len) - 1);
	if (!((trailer & 252) == 40)) {

		/* Native code trailer id */
		/* ... fail somehow */

return -1;
	}

	/* points to trailer kind byte */

pos = ((methodObj + BaseHeaderSize) + len) - 1;
	trailerSize = (byteAt(pos - 3)) + ((byteAt(pos - 4)) << 8);

	/* now points to first byte of var-length encoded source pointer */

pos -= 5;
	while ((byteAt(pos)) > 127) {
		pos -= 1;
	}

	/* copy machine code */

instr = ((((sqInt) (firstFixedField(methodObj)))) + len) - trailerSize;
	copyInstructionsFromupTo(instr, pos);
	return 0;
}
...
{
	// StackToRegisterMappingCogit>>#genPushRegisterArgsForAbortMissNumArgs:
...
{
	// StackToRegisterMappingCogit>>#genPushRegisterArgsForNumArgs:
	if (numArgs <= (numRegArgs())) {
		/* begin MoveMw:r:R: */
genoperandoperandoperand(MoveMwrR, 0, SPReg, TempReg);
		/* begin MoveR:Mw:r: */
...
genoperandoperand(MoveCqR, argInt, Arg0Reg);
	...
	genMarshalledSendnumArgs(specialSelector(byte0 - (
#if MULTIPLEBYTECODESETS
	(bytecodeSetOffset == 256
		? 80 + 256
		: 176)
...
genoperandoperand(MoveCqR, argInt, Arg0Reg);
	...
	return genMarshalledSendnumArgs(specialSelector(byte0 - (
#if MULTIPLEBYTECODESETS
	(bytecodeSetOffset == 256
		? 80 + 256
		: 176)
...
{
	// CogObjectRepresentationForSqueakV3>>#genSSPushSlot:reg:
...
{
	// CogObjectRepresentationForSqueakV3>>#isImmediate:
	return (anOop & 1);
}
...
{
	// Cogit>>#mapFor:bcpc:performUntil:arg:
    sqInt aMethodObj;
    sqInt annotation;
    sqInt bcpc;
    sqInt bsOffset;
...
methodHeader1 = (homeMethod->methodHeader);
		bsOffset = 
#    if MULTIPLEBYTECODESETS
			(headerIndicatesAlternateBytecodeSet(methodHeader1)
						? 256
						: 0)
#    else /* MULTIPLEBYTECODESETS */
			0
...
{
	// StackToRegisterMappingCogit>>#registerMaskFor:
	return 1 << (1 - reg);
}
...
{
	// StackToRegisterMappingCogit>>#registerMaskFor:and:
...
{
	// StackToRegisterMappingCogit>>#registerMaskFor:and:and:
...
{
	// Cogit>>#unlinkIfLinkedSend:pc:of:
    sqInt entryPoint;
    sqInt off;
    sqInt offset;
    sqInt *sendTable;
